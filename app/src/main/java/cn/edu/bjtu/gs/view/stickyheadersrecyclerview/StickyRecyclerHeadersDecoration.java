package cn.edu.bjtu.gs.view.stickyheadersrecyclerview;
...
import cn.edu.bjtu.gs.view.stickyheadersrecyclerview.caching.HeaderProvider;
import cn.edu.bjtu.gs.view.stickyheadersrecyclerview.caching.HeaderViewCache;
import cn.edu.bjtu.gs.view.stickyheadersrecyclerview.calculation.DimensionCalculator;
import cn.edu.bjtu.gs.view.stickyheadersrecyclerview.rendering.HeaderRenderer;
import cn.edu.bjtu.gs.view.stickyheadersrecyclerview.util.LinearLayoutOrientationProvider;
import cn.edu.bjtu.gs.view.stickyheadersrecyclerview.util.OrientationProvider;
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (hasStickyHeader || mHeaderPositionCalculator.hasNewHeader(position, mOrientationProvider.isReverseLayout(parent))) {
                ...
                header.setTag(mAdapter.getHeaderId(position));
