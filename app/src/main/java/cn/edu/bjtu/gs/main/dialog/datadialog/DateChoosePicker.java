package cn.edu.bjtu.gs.main.dialog.datadialog;
...
import cn.edu.bjtu.gs.view.picker.ArrayWheelAdapter;
import cn.edu.bjtu.gs.view.picker.DateFormatManager;
import cn.edu.bjtu.gs.view.picker.LunarItem;
import cn.edu.bjtu.gs.view.picker.LunarParser;
import cn.edu.bjtu.gs.view.picker.NumericWheelAdapter;
import cn.edu.bjtu.gs.view.picker.OnWheelChangedListener;
import cn.edu.bjtu.gs.view.picker.WheelView;

/**
 * Created by zgw on 16/5/14 15:14.
 */
public class DateChoosePicker extends Dialog {
    ...
    public interface OnDateTimeSetListener {
        void onDateTimeSet(DateChoosePicker picker);
    }

    public interface OnAbortPickerListener {
        void OnAbort(DateChoosePicker picker);
    }

    public DateChoosePicker setOnDateTimeSetListener(OnDateTimeSetListener l) {
        this.mOnDateTimeSetListener = l;
        return this;
    }

    public DateChoosePicker setOnAbortPickerListener(OnAbortPickerListener l) {
     ...
     * @param isStillNow
     */
    public DateChoosePicker(Context context, boolean solar, int year, int month, int day, boolean isStillNow) {
        super(context);
        this.mYearShow = true;
    ...
    public DateChoosePicker(Context context, boolean solar, int year, int month, int day) {
        super(context);
        this.mYearShow = true;
        init(solar, year, month, day);
    ...
    public DateChoosePicker(Context context, boolean isYearShow, boolean solar, int year, int month, int day) {
        super(context);
    ...
    public DateChoosePicker(Context context, boolean isYearShow, boolean solar, int year, int month, int day, boolean isLeapMonthShow) {
        super(context);
        this.mYearShow = isYearShow;
    ...
    private void init(final boolean solar, final int year, final int month, final int day) {
        ...
        setContentView(R.layout.picker_date_choose_layout);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnDateTimeSetListener != null) {
                    mOnDateTimeSetListener.onDateTimeSet(DateChoosePicker.this);
                }
            }
        });
